	...
	<div class="desktop-secton">
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-12">
					<b-button variant="success" class="mt-3" block @click="openCustomModal()" style="width:360px;margin:0 auto;font-size:35px;font-weight:bold;text-shadow:1px 1px 1px #000000;padding:10px;-webkit-box-shadow: 0 0 20px 1px #fafafa;box-shadow: 0 0 20px 1px #fafafa;cursor:pointer;">
						DOWNLOAD NOW!
					</b-button>
				</div>

				<div class="col-sm-12" @click="openCustomModal()">
					<img src="/image/download/footer.png" @click="openCustomModal()" style="display:block;margin:0 auto 50px;cursor:pointer;">

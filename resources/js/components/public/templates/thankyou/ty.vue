...
<div class="template">
	<div class="row" style="background: #1c1c1c; margin-top:0">
		...
		<div class="col-sm-6  no-padding-tb">
			<div class="mobile-header-container" style="width:60%;margin: 0 auto;display: block;height: 55px;">
					...
					<div class="row">
						...
						<div class="col-sm-8 pt0">
							...
							<template v-if="hasLogedInFb">
								<div class="mcwidget-embed" data-widget-id="15043748" :data-widget-payload="thankYouData.user_id" style="margin-top:20px;margin-bottom:20px;"></div>
							</template>
							<template v-else>
...
export default {
    ...
    mounted() {
		...
		**/
		...
		/**
		setTimeout(()=>{
			gtag('event', 'conversion', {'send_to': 'AW-743664533/7CjDCP_h7_ABEJXXzeIC'});
		}, 1000);
		**/
